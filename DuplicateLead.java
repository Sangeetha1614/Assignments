...
public class DuplicateLead {
	...
	driver.findElement(By.id("createLeadForm_firstName")).sendKeys("testleaf2");
	driver.findElement(By.id("createLeadForm_lastName")).sendKeys("test");
	driver.findElement(By.name("departmentName")).sendKeys("Selenium1");
    driver.findElement(By.name("description")).sendKeys("Selenium training");
	driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("SeleniumDuplicate@gmail.com");
	...
	driver.findElement(By.id("createLeadForm_firstName")).sendKeys("testleaf3");
	driver.findElement(By.className("smallSubmit")).click();
